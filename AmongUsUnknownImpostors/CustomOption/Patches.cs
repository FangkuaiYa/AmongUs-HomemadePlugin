    ...
    public static class Patches
    {
        ...
        private class SettingsUpdate
        {
            ...
            public static void Postfix(GameSettingMenu __instance)
            {
                ...
                if (button == null)
                {
                    button = GameObject.Instantiate(GameObject.Find("GameSettingsButton"), GameObject.Find("LeftPanel").transform);
                    button.transform.localPosition += new Vector3(0f, 1.25f, 0f);
                    button.name = "ModSettings";
                    __instance.StartCoroutine(Effects.Lerp(1f, new Action<float>(p =>
                    {
                        button.transform.FindChild("FontPlacer").GetComponentInChildren<TextMeshPro>().text = Language.GetString("option.settingbutton");
                    })));
        ...
        class SettingsAwake
        {
            ...
            public static void Postfix(LobbyViewSettingsPane __instance)
            {
                ...
                if (tab == null)
                {
                    ...
                    __instance.StartCoroutine(Effects.Lerp(1f, new Action<float>(p =>
                    {
                        tab.transform.FindChild("FontPlacer").GetComponentInChildren<TextMeshPro>().text = Language.GetString("option.settingbutton");
                    })));
